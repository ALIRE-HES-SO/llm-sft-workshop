...
- and even deploy your model, and interact with it.

Note that the goal is not to teach you the detailed theory of fine-tuning, which is not necessary to follow the workshop.
Only basic knowledge of LLMs is necessary, and any more advanced concepts will be explained as needed.
